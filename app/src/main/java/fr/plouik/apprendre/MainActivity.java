...
public class MainActivity extends Activity implements OnItemClickListener{
    ...
    */
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        autoCompView.setAdapter(new GooglePlacesAutocompleteAdapter(this, R.layout.list_item));     // il faut une liste adapter pour l'autocomplete
        autoCompView.setOnItemClickListener(this);

        btn_get.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {                    //button qui launche l'activité map ( text = ploup =
    ...
    public  ArrayList autocomplete(String input) {
        ArrayList resultList = null;                // fait une demande à google, si tous de passe bien resultList est différent de null
    ...
    class GooglePlacesAutocompleteAdapter extends ArrayAdapter implements Filterable {
        ...
        @Override
        public Filter getFilter() {                     //le filter donne le delay d'actualisation du TextView
